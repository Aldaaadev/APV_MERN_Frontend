...
const Registrar = () => {
    ...
    const handleSubmit = async e => {
      ...
      if(password.length < 8) {
        setAlerta( { msg: 'El password debe tener mínimo 8 caracteres', error: true } );
        return;
      }
            ...
            <form onSubmit={handleSubmit}>
              <div className='my-5'>
                  ...
                  <input 
                    ...
                    className='border w-full p-3 mt-3 bg-gray-50 rounded-2xl'
                    value={nombre}
                ...
                <input 
                  type="submit"
                  value="Crear Cuenta"
                  className='bg-indigo-600 w-full py-3 px-10 rounded-2xl text-white uppercase
